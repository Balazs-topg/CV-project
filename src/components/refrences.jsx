    ...
    <>
      <div>
        <div className="flex w-full items-center gap-2">
          ...
          <div className="text-black bg-base-200 py-1 px-3 rounded-full border border-white">Refrences</div>
          <div className="bg-white h-[1px] grow"></div>
        </div>
      </div>
      ...
      {list.map((WorkExp) => (
        <div className="collapse collapse-arrow	bg-base-200 border border-white shrink-0" key={WorkExp.id}>
          <input type="checkbox" />
          <div className="collapse-title text-xl font-medium">Refrence</div>
